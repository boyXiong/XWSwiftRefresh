#
#  Be sure to run `pod spec lint XWSwiftRefresh.podspec' to ensure this is a
...
# Or just: s.author    = "boyXiong"
# s.authors            = { "boyXiong" => "huangyibiao@haodf.com" }
...
s.source       = { :git => "https://github.com/boyXiong/XWSwiftRefresh.git", :tag => "0.1.2" }
